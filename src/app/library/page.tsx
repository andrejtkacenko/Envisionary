...
import { Loader2, PlusCircle, Library, User, BadgeCheck, Clock, Server, Users } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-2 sm:space-y-0">
        <div>
          ...
          <p className="text-muted-foreground">
            Browse and import goals from the system or shared by the community.
          </p>
        </div>
      </div>
